...
class HelpfulError(MusicbotException):
    ...
    def message(self):
        return ("\n{}\n{}\n{}\n").format(
            self.preface,
            self._pretty_wrap(self.issue,    "  Problema:  "),
            self._pretty_wrap(self.solution, "  Solución: "))

    @property
    def message_no_format(self):
        return "\n{}\n{}\n{}\n".format(
            self.preface,
            self._pretty_wrap(self.issue,    "  Problema:  ", width=None),
            self._pretty_wrap(self.solution, "  Solución: ", width=None))
